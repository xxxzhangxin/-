...
//			DEBUG_LOG("alarmFlag = %d\r\n", alarmFlag);
			...
			/********** 输出调试信息 **************/
			DEBUG_LOG(" | 湿度：%d.%d C | 温度：%d.%d %% | 二氧化碳：%d | 氧气：%d |  指示灯：%s | 报警器：%s | ",humidityH,humidityL,TemperatureH,TemperatureL, CO2Data,TVOCData ,Led_Status?"关闭":"【启动】",alarmFlag?"【启动】":"停止");
		}
