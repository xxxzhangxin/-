...
//#define  SGP30_SCL   PBout(7)
//#define  SGP30_SDA   PBout(6)

#define  SGP30_SCL_LOW    GPIO_ResetBits ( GPIOB, GPIO_Pin_7 )
#define  SGP30_SCL_HIGH    GPIO_SetBits ( GPIOB, GPIO_Pin_7 )

#define  SGP30_SDA_LOW    GPIO_ResetBits ( GPIOB, GPIO_Pin_6 )
#define  SGP30_SDA_HIGH    GPIO_SetBits ( GPIOB, GPIO_Pin_6 )
